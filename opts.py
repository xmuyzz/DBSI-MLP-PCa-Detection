...
def parse_opts():
    ...
    parser.add_argument('--exclude_list', default=['001_ZHOU_CHAO_GANG', '002_ZHU_XIN_GEN', '007_SHEN_QIU_YU',
                        '016_LIU_FENG_MEI', '028_XUE_LUO_PING'], type=list, help='exclude list')

    # train model
    parser.add_argument('--x_input', default=range(7, 30), type=list, help='input image metrics')
